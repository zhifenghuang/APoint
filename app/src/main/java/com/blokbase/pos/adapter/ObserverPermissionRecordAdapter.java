...
public class ObserverPermissionRecordAdapter extends BaseQuickAdapter<ObserverPermissionRecordBean, BaseViewHolder> {

    private Context mContext;
    private String mType;

    public ObserverPermissionRecordAdapter(Context context, String type) {
